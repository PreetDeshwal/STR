  ...
  return (
    ...
    <section className="footer">
        <div className="box-container">
          <div className="box">
            <h3>Address</h3>
            <a href="googlemaplink">Mohali, Punjab</a>
        ...
        <div className="box">
            <h3>Contact Us </h3>
                ...
                <i className="fa">
                <a href="tel:+91 8888817886">+91 7088038004 </a></i>  
                <br></br>
                <i className="fa">
                <a href="mailto:info.shubham@gmail.com">preetdeshwal63@gmail.com</a></i>
            </div>
        <div className="box">
            <h3>Follow us</h3>
            <link
    ...
    <div className="credits">
        <p>© 2024 Preet Deshwal. All Rights Reserved.</p>
      </div>
    </div>
    </>
  );
